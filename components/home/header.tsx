...
export default function HomeHeader() {
  ...
  return (
    <header className="px-4 sm:px-6 pt-4 sm:pt-6 pb-4 sm:pb-6 sticky top-0 z-10 bg-gradient-to-b from-background via-background to-background/80 backdrop-blur-md border-b border-border/50 max-w-lg mx-auto">
